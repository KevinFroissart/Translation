...
<div class="prodBreadcrm">
    <div class="container">
        <a href="/">Accueil</a> &gt; <span>Paiement</span>
    </div>
</div>

<div class="checkout-sec">
	<div class="container">
    	<p class="comnHdng">Complétez votre commande</p>
        <p class="s3-subHdng">Vous êtes à un pas de profiter des avantages du CBD!</p>
        
        <div class="chk-sec-block">
            <div class="chk-rit-prc-box show-mob">
                <p class="chk-head" id="summry-tog">Récapitulatif de la commande</p>
                ...
                <div class="summry-drower" style="display: none;">
                  ...
                  ?>
                    ...
                    <div class="chk-prc-sub-head border">
						<p class="chk-prc-p3">Livraison & Service</p>
                        <p class="chk-prc-p4">$0.00</p>
                    </div>
                    <div class="chk-prc-sub-head">
						<p class="chk-prc-p3">TVA</p>
                        <p class="chk-prc-p4">$0.00</p>
                    </div>
          ...
          <input type="hidden" name="action" value="billingform">
        	<div class="chk-box-lft">
            	<p class="chk-head">Informations sur la livraison</p>
                
                <div class="frmBox">
                    <div class="input-box hlf">
                        <img src="images/ic1.png" alt="" class="fldicon">
                        <input type="text" name="shippingFirstName" class="field-all" placeholder="Prénom">
                    </div>
                    <div class="input-box hlf fr">
                        <img src="images/ic1.png" alt="" class="fldicon">
                        <input type="text" name="shippingLastName" class="field-all" placeholder="Nom">
                    </div>
                    ...
                    <div class="input-box">
                        ...
                        <input type="text" name="shippingPhone" class="field-all" placeholder="Numéro de Téléphone">
                    </div>
                    
                    <div class="input-box">
                        <img src="images/ic4.png" alt="ic6" class="fldicon">
                        <input type="text" name="shippingAddress" class="field-all" placeholder="Addresse">
                    </div>
                    
                    <div class="input-box">
                        <img src="images/ic6.png" alt="ic7" class="fldicon">
                        <input type="text" name="shippingCity" class="field-all" placeholder="Ville">
                    </div>
                    ...
                    <div class="input-box hlf fr">
                        ...
                        <input type="text" id="shipping_zip" name="shippingZipPostal" class="field-all" placeholder="Code Postal" maxlength="5" onkeyup="javascript:this.value=this.value.replace(/\s/g, '')">
                ...
                <div class="chk-payment-box">
                	<p class="chk-head">Informations de paiement</p>
                    
                    <label class="fieldToggle">
                    <input type="checkbox" name="togData" id="togData" checked="checked">
                    <span class="togship"></span>
                    L'adresse de facturation est identique à celle d'expédition</label>
                    ...
                    <div class="shipaddress" style="display:none;">
                       <div class="input-box">
                        ...
                        <div class="input-box">
                            <img src="images/ic3.png" alt="ic3" class="fldicon">
                            <input type="text" name="billingPhone" class="field-all" placeholder="Numéro de Téléphone">
                        </div>
                        
                        <div class="input-box">
                            <img src="images/ic4.png" alt="ic6" class="fldicon">
                            <input type="text" name="billingAddress" class="field-all" placeholder="Addresse">
                        </div>
                        
                        <div class="input-box">
                            <img src="images/ic6.png" alt="ic7" class="fldicon">
                            <input type="text" name="billingCity" class="field-all" placeholder="Ville">
                        </div>
                        ...
                        <div class="input-box hlf fr">
                            <img src="images/ic7.png" alt="ic7" class="fldicon">
                            <input type="text" id="billing_zip" name="billingZipPostal" class="field-all" onkeyup="javascript:this.value=this.value.replace(/\s/g, '')" placeholder="Code postal">
                        </div>
                    </div>
                    
                    <div class="card-accept"> Nous acceptons: <img src="images/cc-icon.png"></div>
                    ...
                    <div class="cart-rit-price-row" style="float: left;width: 100%;">
                        <h2>Vous avez un code promotionnel?</h2>

                        <div class="avada-coupon-fields">
                            <?php if (isset($_SESSION['couponeName'])) { ?>
                            <input type="text" name="coupon_code" class="field-all" id="avada_coupon_code" value="<?php echo $_SESSION['couponeName']; ?>" readonly placeholder="Code promotionnel" />
                            <div type="submit" class="fusion-apply-coupon fusion-button button-default fusion-button-default-size button apply_coupon cart-btn-3" id="apply_coupon2" value="Apply coupon">Coupon appliqué</div>
                            <?php } else{ ?>
                                <input type="text" name="coupon_code" class="field-all" id="avada_coupon_code"  value="" placeholder="Code promotionnel" />
                                <div type="submit" class="cart-btn-3" id="apply_coupon" value="Apply coupon">Appliquer la promotion</div>
                                <?php }?>
            ...
            <div class="chk-box-rit">
            	<div class="chk-rit-prc-box show-desk">
                	<p class="chk-head">Récapitulatif de la commande</p>
                    <?php  
                  foreach ($cart as $key => $product) {
                      echo '<div class="chk-prc-sub-head">
                  ...
                  ?>
                    ...
                    <?php if (isset($_SESSION['couponeName'])) { ?>
                      <div class="chk-prc-sub-head">
            <p class="chk-prc-p3">Remise: <?php echo $_SESSION['couponeName']; ?></p>
            ...
            <p class="chk-prc-p3">Remise: <?php echo $_SESSION['couponeName']; ?></p><p class="chk-prc-p4">$0.00</p></div><?php }?>
                ...
                <div class="chk-post-logo">
                    ...
                    Nous estimons que votre commande arrivera le <span class="red-c"><b><script type="text/javascript">getDate(5);</script></b></span>
                </div>
                
                <div class="chk-cust-box">
                	<p class="chk-cust-p1">Témoignages de clients</p>
                    <div class="chk-cust-row">
                    	<img src="images/model1.png" class="chk-fc-1">
                        <p class="chk-cust-p2">J'utilise l'Huile Ultimate CBD depuis plus d'un mois maintenant et je peux affirmer avec certitude qu'elle a été un véritable allié. Cela m'a aidé à commencer à vivre ou devrais-je dire revivre, une vie active! Je vous remercie!</p>
                        <p class="chk-cust-p3">Jessica Brooks <span>Acheteur vérifié</span> <img src="images/star.png" class="chk-star"></p>
                    </div>
                    <div class="chk-cust-row">
                    	<img src="images/model2.png" class="chk-fc-1">
                        <p class="chk-cust-p2">Les Bonbons Ultimate CBD m'ont été recommandé par mon thérapeute et je suis tellement content d'avoir décidé de les essayer! J'utilise également quotidiennement l'huile de CBD. Hautement recommandé</p>
                        <p class="chk-cust-p3">Rod Hebert <span>Acheteur vérifié</span> <img src="images/star.png" class="chk-star"></p>
                    </div>
...
<div class="sectionSix">
	<div class="container">
        ...
        <div class="email-field">
            ...
            <a href="" class="sign-up">S'inscrire <img src="images/sign-arw.png"></a>
        </div>
    </div>
</div>
...
<p id="loading-indicator" class="wait-loader-container" style="display:none;">Traitement en cours...</p>
