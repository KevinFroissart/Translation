...
<div class="prodBreadcrm">
    ...
    <div class="container">
        ...
        <a href="/">Accueil</a> &gt; <a href="cbd-products.php">Produits</a>  &gt; <span>Panier </span>
...
<div class="cart-sec">
	...
	<div class="container">
		...
		<p class="cart-p1">Vous avez <span class="cart-int"><?php echo count($cart); ?></span> articles dans votre commande.</p>    

        

        <div class="cart-heading-row">

        	<div class="cart-col-1">RÉSUMER DE VOTRE COMMANDE</div>

            <div class="cart-col-2">PRIX UNITAIRE</div>

            <div class="cart-col-3">QUANTITÉ</div>
        ...
        <div class="cart-rit-price-row">
        	...
        	<div class="cart-rit-price">Sous-Total: <span class="total">$<?php echo number_format((float)$total, 2, '.', '') ?></span></div>
        ...
        <div class="cart-btn-row">
        	...
        	<a href="cbd-products.php" class="cart-btn-1">Countinuer mes achats</a>

        	<a onClick="submitfort()" class="cart-btn-2">Passer commande</a>
