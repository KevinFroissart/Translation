...
<title>CBD Products - Ultimate CBD Labs</title>
...
<div class="sectionThree products-sec">
	<div class="container">
    	...
    	<p class="comnHdng">Featured Products</p>
        <p class="s3-subHdng">Choose From Our CBD Range & Start Your Journey Towards Better Health </p>
        <ul class="prod-list">
        	<li>
            	<img src="images/prod1.png" class="cbd-prod">
                <span>CBD Oil</span>
                <p>500MG</p>
                <a href="cbd-oil.php" class="learn-btn shop-btn">Shop Now <img src="images/learn-more-arw.png"></a>
            </li>
            <li>
            	<img src="images/prod4.png" class="cbd-prod">
                <span>CBD Gummies</span>
                <p>300MG</p>
                <a href="cbd-gummies.php" class="learn-btn shop-btn">Shop Now <img src="images/learn-more-arw.png"></a>
            </li>
            <li>
            	<img src="images/prod3.png" class="cbd-prod">
                <span>CBD Capsules</span>
                <p>300MG</p>
                <a href="cbd-capsules.php" class="learn-btn shop-btn">Shop Now <img src="images/learn-more-arw.png"></a>
            </li>
            <li>
            	<img src="images/prod2.png" class="cbd-prod">
                <span>CBD Pleasure Gel</span>
                <p>100MG</p>
                <a href="cbd-lube-pleasure-gel.php" class="learn-btn shop-btn">Shop Now <img src="images/learn-more-arw.png"></a>
            </li>
        </ul>
    </div>
</div>
