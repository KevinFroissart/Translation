...
<title>Buy CBD Capsules For Pain | CBD 300mg Capsules - Ultimate CBD Labs</title>
...
<div class="prodBreadcrm">
    ...
    <div class="container">
        ...
        <a href="/">Home</a> > <a href="cbd-products.php">Products </a> > <span>CBD Capsules</span>
...
<div class="deailsSec1">
	...
	<div class="container">
    	...
    	<h1 class="prod-nameHdng forMob">CBD Capsules <span>300MG</span> <span class="prc">| &nbsp;<span class="one_price">$<?php echo $p_info[$pr1]['price']; ?></span> <span class="rec_price rec_price_ext">$<?php echo $p_info[$pr2]['price']; ?></span></span></h1>
        ...
        <div class="prodDetls-Rght">
        	...
        	<p class="prod-nameHdng hide-mob">CBD Capsules <span>300MG</span> <span class="prc">| &nbsp;<span class="one_price">$<?php echo $p_info[$pr1]['price']; ?></span> <span class="rec_price rec_price_ext">$<?php echo $p_info[$pr2]['price']; ?></span></span></p>

            <p class="prd-p1 hide-mob"><img src="images/stars.png" class="prd-stars" alt="Star Rating"></p>

            <p class="prd-p2">Formulated with essential cannabinoids extracted from pure hemp extract, the high potency CBD Capsules offers quick absorption and fast acting results.</p>
            <ul class="dtlsec-list">
            	<li>Maximum Strength 300MG Blend</li>
                <li>Easy and Convenient To Take</li>
...
<div class="sectionOne">
	<div class="container">
    	<div class="s1-left">
        	<p class="comnHdng">Ultimate CBD Capsules</p>
            ...
            <p class="comn-para"><b>Ultimate CBD Capsules</b> harnesses the therapeutic benefits of CBD, a safe & non-psychoactive compound found in hemp leaves. CBD has been found to have a positive impact on key body functions including neurological, physical & psychological.</p>
            <p class="comn-para"><b>Ultimate CBD Capsules is made from 100% legal, safe & US grown and harvested hemp extract, to ensure high potency & maximum health benefits.</b></p>
            <ul class="s1-list">
                ...
                <li><img src="images/prods1-icn22.png"><br>DOSE / SERVING<br> <span>83.3 mg / ml</span></li>
            </ul>
...
<div class="deailsSec2">
	...
	<div class="container">
    	...
    	<p class="comnHdng">Benefits Of Ultimate CBD Capsules</p>
        ...
        <div class="deailsSec2-rgt">
        	...
        	<ul>
                ...
                <li>
                    ...
                    <p>By reducing inflammation, supporting joint health & reducing pain-signalling, CBD Capsules helps you live-pain free & active.</p>
...
<div class="deailsSec3 capsules-s3">
	...
	<div class="container">
    	...
    	<div class="detls3-lft">
            ...
            <p class="comn-subHdng">Learn How CBD Capsules Works</p>
            ...
            <p class="cbd-workHdng">Ultimate CBD Capsules - Triple Action Formula</p>
            ...
            <ul class="cbd-work-list">
                ...
                <li>
                    ...
                    <p>Regular Ultimate CBD Capsules supplementation helps fill nutritional gaps and supports overall health & wellness.</p>
...
<div class="dtls-strip capsules-strip1">
	...
	<div class="container">
    	...
    	<div class="strp-rgt">
        	...
        	<p class="strp-txt1">Order Your Bottle Of<br>Ultimate CBD Capsules</p>
...
<div class="deailsSec4">
	...
	<div class="container">
    	...
    	<p class="comnHdng">Why Choose Ultimate CBD Capsules</p>
        ...
        <ul class="brand-logo-box">
            ...
            <li>
                ...
                <p>Offers quick delivery & longevity of CBD molecules in the bloodstream.</p>
	...
	<div class="container">
        ...
        <div class="result-box">
            ...
            <div class="testi-row">
                ...
                <p>I was worried that the capsules would be a little large, but they are perfect, easy to swallow. I also feel they are more effective than the last brand that I was taking for sure.</p>
            ...
            <div class="testi-row">
                ...
                <p>I was recommended this product by my colleague to cope up with the high-stress work at office and I am glad I decided to give it a go. Has been pretty helpful. I would recommend taking 2 doses of 1 capsule each in the morning and at night.</p>
            ...
            <div class="testi-row">
                ...
                <p>I have been using CBD Capsules for over a month not and I can say with confidence they have worked great to reduce my back and neck pain largely. I am able to get back to some active walking.</p>
