...
<div class="prodBreadcrm">
    ...
    <div class="container">
        ...
        <a href="/">Home</a> &gt; <span>Thankyou </span>
...
<div class="cart-sec">
	...
	<div class="container">
        ...
        <div class="thankyou-box">
            ...
            <p class="thnk-p1">Thank You For Your Order!</p>

            <p class="thnk-p2">Congratulations! You've taken the first step towards a better life</p>

            <p class="thnk-p3">Order Receipt Number:  <?php echo $_SESSION['customer_id']; ?></p>

            <p class="thnk-p3">Order Placed Date:  <script type="text/javascript">getDate(0);</script></p>
            ...
            <div class="cart-rit-price-row">
                ...
                <div class="cart-rit-price">Sub Total: <span>$<?php echo number_format((float)$total, 2, '.', '') ?></span></div>

                <?php if (isset($_SESSION['couponeName'])) { ?><div class="cart-rit-price">Discount: <?php echo $_SESSION['couponeName']; ?><span>$<?php echo number_format($_SESSION['coupon_cart']['totalfull']['totaldiscount'], 2, '.', '');?></span></div>
            ...
            <div class="thank-personal-dtl">
            	...
            	<div class="thnk-p-dtl">
                	...
                	<p class="thnk-p-dtl-p1">SHIPPING INFO</p>
                ...
                <div class="thnk-p-dtl">
                	...
                	<p class="thnk-p-dtl-p1">Billing INFO</p>
